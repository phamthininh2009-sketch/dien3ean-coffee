...
export default function PageHero({ label, title, desc, image }) {
  return (
    <section className="relative flex min-h-[52vh] items-end overflow-hidden bg-coffee-dark pt-32 pb-16 text-cream">
      {image && (
        <>
      ...
      <div className="container-page relative">
        ...
        <h1 className="font-serif-heading max-w-3xl text-4xl leading-tight sm:text-5xl md:text-6xl">{title}</h1>
